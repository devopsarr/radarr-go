...
type ReleaseResource struct {
	...
	IndexerFlags interface{} `json:"indexerFlags,omitempty"`
...
// GetMovieRequested returns the MovieRequested field value if set, zero value otherwise.
func (o *ReleaseResource) GetMovieRequested() bool {
	if o == nil || IsNil(o.MovieRequested) {
		var ret bool
		return ret
	}
	return *o.MovieRequested
}

// GetMovieRequestedOk returns a tuple with the MovieRequested field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReleaseResource) GetMovieRequestedOk() (*bool, bool) {
	if o == nil || IsNil(o.MovieRequested) {
		return nil, false
	}
	return o.MovieRequested, true
}
...
// SetMovieRequested gets a reference to the given bool and assigns it to the MovieRequested field.
...
// SetIndexerFlags gets a reference to the given interface{} and assigns it to the IndexerFlags field.
...
func (o ReleaseResource) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MovieRequested) {
		toSerialize["movieRequested"] = o.MovieRequested
	}
