...
type ApiPutMovieFileBulkRequest struct {
	ctx context.Context
	ApiService *MovieFileAPIService
	movieFileResource *[]MovieFileResource
}

func (r ApiPutMovieFileBulkRequest) MovieFileResource(movieFileResource []MovieFileResource) ApiPutMovieFileBulkRequest {
	r.movieFileResource = &movieFileResource
	return r
}

func (r ApiPutMovieFileBulkRequest) Execute() (*http.Response, error) {
	return r.ApiService.PutMovieFileBulkExecute(r)
}

/*
PutMovieFileBulk Method for PutMovieFileBulk

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPutMovieFileBulkRequest
*/
func (a *MovieFileAPIService) PutMovieFileBulk(ctx context.Context) ApiPutMovieFileBulkRequest {
	return ApiPutMovieFileBulkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *MovieFileAPIService) PutMovieFileBulkExecute(r ApiPutMovieFileBulkRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MovieFileAPIService.PutMovieFileBulk")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
