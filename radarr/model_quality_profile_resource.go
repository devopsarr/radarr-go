...
// GetMinUpgradeFormatScore returns the MinUpgradeFormatScore field value if set, zero value otherwise.
func (o *QualityProfileResource) GetMinUpgradeFormatScore() int32 {
	if o == nil || IsNil(o.MinUpgradeFormatScore) {
		var ret int32
		return ret
	}
	return *o.MinUpgradeFormatScore
}

// GetMinUpgradeFormatScoreOk returns a tuple with the MinUpgradeFormatScore field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QualityProfileResource) GetMinUpgradeFormatScoreOk() (*int32, bool) {
	if o == nil || IsNil(o.MinUpgradeFormatScore) {
		return nil, false
	}
	return o.MinUpgradeFormatScore, true
}
...
// SetMinUpgradeFormatScore gets a reference to the given int32 and assigns it to the MinUpgradeFormatScore field.
func (o *QualityProfileResource) SetMinUpgradeFormatScore(v int32) {
	o.MinUpgradeFormatScore = &v
}
...
func (o QualityProfileResource) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MinUpgradeFormatScore) {
		toSerialize["minUpgradeFormatScore"] = o.MinUpgradeFormatScore
	}
