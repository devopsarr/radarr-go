...
func (r ApiGetBlocklistRequest) MovieIds(movieIds []int32) ApiGetBlocklistRequest {
	r.movieIds = &movieIds
	return r
}

func (r ApiGetBlocklistRequest) Protocols(protocols []DownloadProtocol) ApiGetBlocklistRequest {
