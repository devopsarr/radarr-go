...
func (r ApiGetWantedCutoffRequest) Execute() (*MovieResourcePagingResource, *http.Response, error) {
...
func (a *CutoffAPIService) GetWantedCutoffExecute(r ApiGetWantedCutoffRequest) (*MovieResourcePagingResource, *http.Response, error) {
	var (
