...
// checks if the MovieMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MovieMetadata{}
...
func (o MovieMetadata) ToMap() (map[string]interface{}, error) {
