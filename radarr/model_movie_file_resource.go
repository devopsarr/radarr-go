...
type MovieFileResource struct {
	...
	CustomFormatScore NullableInt32 `json:"customFormatScore,omitempty"`
...
// GetCustomFormatScore returns the CustomFormatScore field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MovieFileResource) GetCustomFormatScore() int32 {
	if o == nil || IsNil(o.CustomFormatScore.Get()) {
		var ret int32
		return ret
	}
	return *o.CustomFormatScore.Get()
}
...
func (o *MovieFileResource) GetCustomFormatScoreOk() (*int32, bool) {
	...
	return o.CustomFormatScore.Get(), o.CustomFormatScore.IsSet()
}

// HasCustomFormatScore returns a boolean if a field has been set.
func (o *MovieFileResource) HasCustomFormatScore() bool {
	if o != nil && o.CustomFormatScore.IsSet() {
		return true
	}
...
// SetCustomFormatScore gets a reference to the given NullableInt32 and assigns it to the CustomFormatScore field.
func (o *MovieFileResource) SetCustomFormatScore(v int32) {
	o.CustomFormatScore.Set(&v)
}
// SetCustomFormatScoreNil sets the value for CustomFormatScore to be an explicit nil
func (o *MovieFileResource) SetCustomFormatScoreNil() {
	o.CustomFormatScore.Set(nil)
}
...
func (o *MovieFileResource) SetIndexerFlagsNil() {
...
func (o MovieFileResource) ToMap() (map[string]interface{}, error) {
	...
	if o.CustomFormatScore.IsSet() {
		toSerialize["customFormatScore"] = o.CustomFormatScore.Get()
	}
