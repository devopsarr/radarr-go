...
type ApiGetQualityDefinitionLimitsRequest struct {
	ctx context.Context
	ApiService *QualityDefinitionAPIService
}

func (r ApiGetQualityDefinitionLimitsRequest) Execute() (*QualityDefinitionLimitsResource, *http.Response, error) {
	return r.ApiService.GetQualityDefinitionLimitsExecute(r)
}

/*
GetQualityDefinitionLimits Method for GetQualityDefinitionLimits

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetQualityDefinitionLimitsRequest
*/
func (a *QualityDefinitionAPIService) GetQualityDefinitionLimits(ctx context.Context) ApiGetQualityDefinitionLimitsRequest {
	return ApiGetQualityDefinitionLimitsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *QualityDefinitionAPIService) GetQualityDefinitionLimitsExecute(r ApiGetQualityDefinitionLimitsRequest) (*QualityDefinitionLimitsResource, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *QualityDefinitionLimitsResource
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QualityDefinitionAPIService.GetQualityDefinitionLimits")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/qualitydefinition/limits"
